...
如果没有这个声明，系统会隔段时间显示通知([discussions#744](https://github.com/orgs/gkd-kit/discussions/744))，内容如下

`查看权限设置(GKD可以查看和控制您的屏幕。点按即可查看。)`

如果你无法忍受这个通知，切换到 gkd 渠道即可
...
可以通过以下方式解决, 可在 设置 - 关于 - 分享应用 获取 APK 文件
